...
def create_visualizations(gaussian_data, tanh_data, gaussian_rmsd, tanh_rmsd):
    ...
    # 保存高质量图片
    plt.savefig('/datapool/data3/storage/pengxingang/pxg/hyc/funcmol-main-neuralfield/field_methods_comparison.png', 
...
def main():
    """主函数"""
    file_path = '/datapool/data3/storage/pengxingang/pxg/hyc/funcmol-main-neuralfield/exps/gt_field/field_evaluation_results.csv'
