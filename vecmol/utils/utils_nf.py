...
from vecmol.models.encoder import CrossGraphEncoder
from vecmol.models.decoder import Decoder
import time
...
def create_neural_field(config: dict) -> tuple:
    ...
    dec = Decoder({
        ...
        "cutoff": config["decoder"].get("cutoff", None),  # If None, use default radius as cutoff in EGNN
