...
from vecmol.analysis.rdkit_functions import Molecule
...
# 简化的导入，不依赖MiDi
from vecmol.analysis.rdkit_functions import Molecule, check_stability
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--openbabel":
        ...
        # 默认评估VecMol生成的分子
        molecule_dir = "/data/huayuchen/Neurl-voxel/exps/vecmol/fm_qm9/20250912/molecule"
