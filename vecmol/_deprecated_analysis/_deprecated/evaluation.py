...
# 导入各个分析模块
from vecmol.analysis.analyze_denoiser_results import (
    create_visualizations,
    compare_with_qm9
)
from vecmol.analysis.analyze_molecule_structure import analyze_molecules
from vecmol.analysis.evaluate_molecules_from_codes import (
...
def main():
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='vecmol/configs/evaluation.yaml',
        help='配置文件路径（YAML格式，默认为 vecmol/configs/evaluation.yaml）'
    )
    parser.add_argument(
        '--output_dir',
        type=str,
