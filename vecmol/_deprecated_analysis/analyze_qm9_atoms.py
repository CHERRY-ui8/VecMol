...
def analyze_qm9_atoms(data_dir="/home/huayuchen/Neurl-voxel/vecmol/dataset/data/qm9"):
    """
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(script_dir, "vecmol", "analysis", "qm9_statistics.txt")
